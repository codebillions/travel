...
<!--SIGNIN-->
    <section class="signin">
        ...
        <form class="signinbox" action="data.php?pg=Login" method="POST">
            <h1>SIGNIN</h1>

            <input type="email" name="email" placeholder="Email">

            <input style="margin-top: 30px;" type="password" name="pwd" placeholder="Password">

            <p class=" check" style="margin: -7% 0 0 -13%;"> <input style="width: 15px;
    height: 15px;" type="checkbox"> Remind me</p>

            <div class="signinbtn">
                <input type="submit" value="Login">
            </div>

            <p>You don't have an account? <a class="reg" href="signup.php">Signup</a>
            </p>
        </form>
